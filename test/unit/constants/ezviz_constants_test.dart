...
void main() {
  group('EzvizConstants', () {
    ...
    group('setRegion', () {
      test('sets base URL to correct region endpoint', () {
        ...
        EzvizConstants.baseUrl.expectMeaningful(
          equals('https://ieuopen.ezvizlife.com'),
        ...
        EzvizConstants.baseUrl.expectMeaningful(
          ...
          reason:
              'North America region should use official North American endpoint',
        );
        ...
        EzvizConstants.baseUrl.expectMeaningful(
          equals('https://isgpopen.ezvizlife.com'),
  ...
  group('EzvizRegion enum', () {
    test('contains expected regions', () {
      ...
      final actualRegions = EzvizRegion.values.map((r) => r.name).toSet();
      ...
      String getRegionDescription(EzvizRegion region) {
        switch (region) {
          ...
          case EzvizRegion.russia:
            return 'Russia/CIS';
          case EzvizRegion.northAmerica:
            return 'USA/Canada/North America';
          case EzvizRegion.singapore:
            return 'Singapore/SEA';
          case EzvizRegion.southAmerica:
            return 'Mexico/Brazil/South America';
